                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                  ...
                                  <!-- /.card-header -->
                                  <!-- form start -->
                                  <form action="/station/save" method="POST" style="font:14">
                                    <div class="card-body">
                                        <div class="row">
                                        <div class="col-sm-2">
                                      ...
                                      <div class="col-sm-4" id="abc">
                                          <div class="form-group">
                                              ...
                                              <select class="form-control" name="journey_from" id="journey_from">
		                           <c:forEach items="${roads }" var="r">
								    <option value="${r.starting_station_name }"> ${ r.starting_station_name}</option>
								   </c:forEach>
								  </select>
                                          </div>
                                         </div>
                                         <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-4">
                                            <div class="form-group">
                                                  <label for="exampleInputPassword1"> Journey To</label>
                                                  <select class="form-control" name="journey_to" id="journey_to">
				                          <c:forEach items="${roads }" var="r">
										    <option value="${r.ending_station_name }"> ${ r.ending_station_name}</option>
										   </c:forEach>
									  </select>
                                             </div>
                                         </div>
                                        ...
                                        <div class="col-sm-4" id="abc">
                                         ...
                                         <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="time" id = "a">
                                             </div>
                                         </div>
                                       </div>
                                       <div class="row">
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="col-sm-4" id="abc">
                                            <div class="form-group">
                                                  <label for="name">Class</label>
                                                  <select class="form-control" name="seat_price" id="seat_price">
				                          <c:forEach items="${price }" var="p">
										    <option value="${p.seat_price }"> ${p.seat_name}</option>
										   </c:forEach>
										 </select>
                                            </div>
                                         </div>
                                         <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                                  <label for="exampleInputPassword1"> Ticket Price</label>
                                                  <input type="text" name="seat_name" id="a"/> 
                                             </div>
                                         </div>
                                       </div>
                                       <div class="row">
                                       ...
                                       <div class="card-footer">
              								<center><button type="submit" class="btn btn-info" text-aline="center"> Save </button></center>
            							</div>	
                                </div>
                              </form>
                            </div>
